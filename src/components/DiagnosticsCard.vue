...
/* Couleurs DPE */
.green-a    { background-color: #2ecc71; }
.green-b    { background-color: #27ae60; }
.green-c    { background-color: #1abc9c; }
.yellow     { background-color: #f1c40f; }
.orange-a   { background-color: #e67e22; }
.orange-b   { background-color: #d35400; }
.red        { background-color: #e74c3c; }

/* Couleurs GES */
.blue-a     { background-color: #a0d8ef; }
.blue-b     { background-color: #74b9ff; }
.blue-c     { background-color: #3498db; }
.gray-a     { background-color: #7f8c8d; }
.gray-b     { background-color: #636e72; }
.gray-c     { background-color: #2d3436; }
...
.details-button {
  ...
  border: none;
  cursor: pointer;
  box-shadow: 0 4px 8px rgba(96, 103, 255, 0.2);
